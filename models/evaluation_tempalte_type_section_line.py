...
class EvaluationTemplateTypeSectionLine(models.Model):
    ...
    criterion_id = fields.Many2one('evaluation.criterion', string="Criterion", required=True,
                                   domain="[('type', '=', section_type), ('criterion_evaluation_type', '=', related_evaluation_template_type)]", store=True)
    related_evaluation_template_type = fields.Selection(related='section_id.evaluation_template_type_id.evaluation_type')
